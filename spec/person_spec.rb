  ...
  describe 'can manage funds if an account has been created' do
    ...
    it 'can not deposit if cash is less than deposit amount' do
      ...
      it 'can withdraw funds' do
        expect(subject.get_cash(amount: 100,
        atm: atm,
        account: subject.account)).to be_truthy
      end
      ...
      it 'can withdraw funds' do
        ...
        describe 'can not manage funds if no account has been created' do
          ...
          it 'cant withdraw funds' do
            expect{ subject.get_cash(100) }.to raise_error(RuntimeError, 'No account present')
          end
        end
      end
